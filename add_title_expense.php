...
<body>
    ...
    <div class="save-event-container">
        <form method="POST" action="save_title_expense.php"> 
            <?php if (isset($errors)) { ?>
                <p><?php echo $errors; ?></p>
            <?php } ?>
            <input class="textfield1" type="text" name="expenseName" id="expenseName" placeholder="Expense Title" required><br><br>
            <br><br>
